...
import com.platzerworld.biergarten.registration.domain.User;
import com.platzerworld.biergarten.registration.service.RegistrationService;
...
@ContextConfiguration(classes=RegistrationApplication.class, loader=SpringBootContextLoader.class)
@Transactional
